...
const CATEGORY_LABELS: Record<ExpenseCategory, string> = {
  ...
  insurance_pet: 'Pet Insurance', insurance_other: 'Other Insurance',
  electricity: 'Electricity', water: 'Water', rates: 'Rates',
  household_goods: 'Household Goods', groceries: 'Groceries', transport: 'Transport', fuel: 'Fuel',
...
const SUPER_CATEGORIES: { label: string; icon: string; color: string; categories: ExpenseCategory[] }[] = [
  ...
  { label: 'Living', icon: '🛒', color: 'bg-teal-500/10 text-teal-400 border-teal-500/20', categories: ['household_goods', 'groceries', 'transport', 'fuel', 'phone_internet', 'personal_care', 'clothing', 'medical', 'pharmacy', 'pet_expenses', 'school_costs'] },
